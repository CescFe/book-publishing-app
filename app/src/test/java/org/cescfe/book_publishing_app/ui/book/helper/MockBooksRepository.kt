...
class MockBooksRepository : BooksRepository {
    ...
    var updateBookResult: DomainResult<Book> = DomainResult.Error(DomainErrorType.UNKNOWN)
    ...
    override suspend fun updateBook(bookId: String, request: UpdateBookRequest): DomainResult<Book> = updateBookResult
